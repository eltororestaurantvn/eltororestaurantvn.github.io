...
$("#hoverbtn2_other").mouseenter(function () {
  ...
  var vitri;
    ...
    $('.pagecountbottom li').click(function() {

      if (($(this).hasClass('pre')!= true) && ($(this).hasClass('nex')!= true) ) {
      $('.pagecountbottom li').removeClass('chon');
      $(this).addClass('chon');

      vitri = $('.pagecountbottom li.chon').index() ;
      console.log(vitri);
    ...
    $('.imgbox').click(function () {
      $(this).children(".fixed-mid").addClass('display');
    })
    $('.fullscreen').click(function (e) {
      console.log("haha")
      $('.fixed-mid.display').removeClass('display');
      e.stopPropagation();
    })
